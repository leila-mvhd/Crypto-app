...
function Pagination({page,setPage}) {
    ...
    return (
        <div className={styles.pagination}>
            ...
            <button onClick={previousHandler} className={page == 1 ? styles.desabled : null}>Previous</button>
            ...
            <button onClick={nextHandler} className={page == 10 ? styles.desabled : null}>Next</button>
